...
import { Icon, StatusBadge, InfoBlock, Row } from "./SharedComponent" // ✅ Added InfoBlock, Row
...
export const OrderDetailPage = ({ order, onBack }) => {
  ...
  return (
    <div>
      ...
      {/* ✅ Using shared InfoBlock & Row components */}
...
// ── Orders List (unchanged - no local InfoBlock/Row used here) ───────
